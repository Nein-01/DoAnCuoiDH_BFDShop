$(document).ready(function () {
    //click chuyển đổi giữa các loại thanh toán
    $(".payment-1").click(function () {
        $('.payment-1').addClass('r-tabs-state-active')
        $('.payment-2,.payment-3,.payment-5').removeClass('r-tabs-state-active')
        $('.payment-1-content').collapse('show')
        $('.payment-1-content,.payment-2-content,.payment-3-content,.payment-4-content,.payment-5-content,.payment-6-content').collapse('hide')
    });

    $(".payment-2").click(function () {
        $('.payment-2').addClass('r-tabs-state-active')
        $('.payment-1,.payment-3,.payment-5').removeClass('r-tabs-state-active')
        $('.payment-2-content').collapse('show')
        $('.payment-2-content,.payment-1-content,.payment-3-content,.payment-4-content,.payment-5-content,.payment-6-content').collapse('hide')
    });

    $(".payment-3").click(function () {
        $('.payment-3').addClass('r-tabs-state-active')
        $('.payment-1,.payment-2,.payment-5').removeClass('r-tabs-state-active')
        $('.payment-3-content').collapse('show')
        $('.payment-3-content,.payment-1-content,.payment-2-content,.payment-4-content,.payment-5-content,.payment-6-content').collapse('hide')
    });
