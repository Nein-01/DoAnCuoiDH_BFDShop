/*
 CanvasJS HTML5 & JavaScript Charts - v3.4.9 GA - 
...
(g.creditHref=ga("iuuqr;..b`ow`rkr/bnl."),g.creditText=ga("B`ow`rKR/bnl")):(l=g.updateOption("creditText"),v=g.updateOption("creditHref"));if(g.creditHref&&g.creditText){g._creditLink||(g._creditLink=document.createElement("a"),g._creditLink.setAttribute("class","canvasjs-chart-credit"),g._creditLink.setAttribute("title","JavaScript Charts"),g._creditLink.setAttribute("style","outline:none;margin:0px;position:absolute;right:2px;top:"+(g.height-14)+"px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Roboto-Regular;"),
...
dockInsidePlotArea:!1,reversed:!1,backgroundColor:w?"transparent":null,borderColor:w?"transparent":null,borderThickness:0,cornerRadius:0,maxWidth:null,maxHeight:null,markerMargin:null,itemMaxWidth:null,itemWidth:null,itemWrap:!0,itemTextFormatter:null,publicProperties:{options:"readWrite",bounds:"readOnly",chart:"readOnly"}},ToolTip:{enabled:!0,shared:!1,animationEnabled:!0,content:null,contentFormatter:null,reversed:!1,backgroundColor:w?"rgba(255,255,255,.9)":"rgb(255,255,255)",borderColor:null,
    borderThickness: 2, cornerRadius: 5, fontSize: 14, fontColor: "black", fontFamily:"Roboto-Regular;",fontWeight:"normal",fontStyle:"italic",updated:null,hidden:null,publicProperties:{options:"readWrite",chart:"readOnly"}},Axis:{minimum:null,maximum:null,viewportMinimum:null,viewportMaximum:null,interval:null,intervalType:null,reversed:!1,logarithmic:!1,logarithmBase:10,title:null,titleFontColor:"black",titleFontSize:20,titleFontFamily:"Roboto-Regular",titleFontWeight:"normal",titleFontStyle:"normal",
    titleWrap: !0, titleMaxWidth: null, titleBackgroundColor: w ? "transparent" : null, titleBorderColor: w ? "transparent" : null, titleBorderThickness: 0, titleCornerRadius: 0, labelAngle: 0, labelFontFamily:"Roboto-Regular",labelFontColor:"black",labelFontSize:12,labelFontWeight:"normal",labelFontStyle:"normal",labelAutoFit:!0,labelWrap:!0,labelMaxWidth:null,labelFormatter:null,labelBackgroundColor:w?"transparent":null,labelBorderColor:w?"transparent":null,labelBorderThickness:0,labelCornerRadius:0,labelPlacement:"outside",labelTextAlign:"left",
...
null,markerBorderThickness:0,mouseover:null,mouseout:null,mousemove:null,click:null,toolTipContent:null,visible:!0,publicProperties:{options:"readWrite",axisX:"readWrite",axisY:"readWrite",chart:"readOnly"}},TextBlock:{x:0,y:0,width:null,height:null,maxWidth:null,maxHeight:null,padding:0,angle:0,text:"",horizontalAlign:"center",textAlign:"left",fontSize:12,fontFamily:"Roboto-Regular",fontWeight:"normal",fontColor:"black",fontStyle:"normal",borderThickness:0,borderColor:"black",cornerRadius:0,backgroundColor:null,
...
Ja={en:{}},y=w?"Roboto-Regular":"Arial",Ea=w?"Impact, Charcoal, sans-serif":"Arial",za={colorSet1:"#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #7F6084 #77A033 #33558B #E59566".split(" "),colorSet2:"#6D78AD #51CDA0 #DF7970 #4C9CA0 #AE7D99 #C9D45C #5592AD #DF874D #52BCA8 #8E7AA3 #E3CB64 #C77B85 #C39762 #8DD17E #B57952 #FCC26C".split(" "),colorSet3:"#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ")},
...
0<this.axisY2.length)for(p=0;p<this.axisY2.length;p++)this.axisY2[p].crosshair&&this.axisY2[p].crosshair.enabled&&this.axisY2[p].renderCrosshair(a,d)}};l.prototype._plotAreaMouseMove=function(a,d){if(this.isDrag&&"none"!==this.plotInfo.axisPlacement){var c=0,b=0,e=c=null,e=0<=this.zoomType.indexOf("x"),f=0<=this.zoomType.indexOf("y"),p=this;"xySwapped"===this.plotInfo.axisPlacement&&(c=f,f=e,e=c);c=this.dragStartPoint.x-a;b=this.dragStartPoint.y-d;if(2<Math.abs(c)&&8>Math.abs(c)&&(this.panEnabled||
...
p.stockChart._rangeEventParameter,p.stockChart)),p.dragStartPoint.x=a,p.dragStartPoint.y=d)}}(e.x1,e.y1,e.x2,e.y2),0);else if(this.zoomEnabled){this.resetOverlayedCanvas();c=this.overlaidCanvasCtx.globalAlpha;this.overlaidCanvasCtx.fillStyle="#A89896";var b=e?this.dragStartPoint.x:this.plotArea.x1,t=f?this.dragStartPoint.y:this.plotArea.y1,B=e?a-this.dragStartPoint.x:this.plotArea.x2-this.plotArea.x1,k=f?d-this.dragStartPoint.y:this.plotArea.y2-this.plotArea.y1;this.validateRegion(b,t,e?a:this.plotArea.x2-
...
p=0<=this.zoomType.indexOf("y"),t=!1,B=[],k=[],m=[],n=0;n<this._axes.length;n++)("axisX"===this._axes[n].type&&f||"axisY"===this._axes[n].type&&p)&&k.push(this._axes[n]);for(p=0;p<k.length;p++){var n=k[p],f=!1,q=n.convertPixelToValue({x:a,y:d}),h=n.convertPixelToValue({x:c,y:b});if(q>h)var r=h,h=q,q=r;if(n.scaleBreaks)for(r=0;!f&&r<n.scaleBreaks._appliedBreaks.length;r++)f=n.scaleBreaks._appliedBreaks[r].startValue<=q&&n.scaleBreaks._appliedBreaks[r].endValue>=h;if(isFinite(n.dataInfo.minDiff))if(r=
...
new Da(a.x1,a.y1,a.x2,a.y2,2)};l.prototype.renderIndexLabels=function(a){var d=a||this.plotArea.ctx,c=this.plotArea,b=0,e=0,f=0,p=f=e=0,t=0,B=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var m=this._indexLabels[a],n=m.chartType.toLowerCase(),q,h,p=la("indexLabelFontColor",m.dataPoint,m.dataSeries),r=la("indexLabelFontSize",m.dataPoint,m.dataSeries),t=la("indexLabelFontFamily",m.dataPoint,m.dataSeries),B=la("indexLabelFontStyle",m.dataPoint,m.dataSeries),k=la("indexLabelFontWeight",m.dataPoint,
...
m.dataPoint.x>e.viewportMaximum||m.bounds.y1>c.y2||m.bounds.y2<c.y1)continue}else if(0<=n.indexOf("bar")||"error"===n){if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>e.viewportMaximum||m.bounds.x1>c.x2||m.bounds.x2<c.x1)continue}else if("candlestick"===n||"ohlc"===n){if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>e.viewportMaximum||Math.max.apply(null,m.dataPoint.y)<f.viewportMinimum||Math.min.apply(null,m.dataPoint.y)>f.viewportMaximum)continue}else if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>
...
n)&&(h=Math.min(m.point.y+t,c.y2-k-t))),h=Math.min(h,f))}else 0<=n.indexOf("line")||0<=n.indexOf("area")||0<=n.indexOf("scatter")?(A="auto",p=4):0<=n.indexOf("stacked")?"auto"===A&&(A="inside"):"bubble"===n&&(A="inside"),h=m.point.y+r/2-k/2+t,"inside"!==A?(e=c.x1,f=c.x2,0>v?(q=m.point.x-("horizontal"===C?B:B-r/2)-p-b,q<e&&(q="auto"===A?Math.max(m.point.x,e)+p:e+p,y=q+B>m.point.x)):(q=m.point.x+("horizontal"===C?0:r/2)+p+b,q>f-B-p-b&&(q="auto"===A?Math.min(m.point.x,f)-("horizontal"===C?B:B/2)-p:f-
...
(n=k.lineDashType,c.setLineDash(h))));if(0<m[u].markerSize||0<k.markerSize){var z=k.getMarkerProperties(u,x,s,c);f.push(z);D=P(D);w&&f.push({x:x,y:s,ctx:b,type:z.type,size:z.size,color:D,borderColor:D,borderThickness:z.borderThickness})}(m[u].indexLabel||k.indexLabel||m[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:m[u],dataSeries:k,point:{x:x,y:s},direction:0>m[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();w&&b.stroke()}}V.drawMarkers(f);w&&
...
easingFunction:K.easing.linear,animationBase:0}}};l.prototype.renderStepLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],p,t=0;t<a.dataSeriesIndexes.length;t++){var B=a.dataSeriesIndexes[t],k=this.data[B];c.lineWidth=k.lineThickness;var m=k.dataPoints,n="solid";if(c.setLineDash){var q=N(k.nullDataLineDashType,
k.lineThickness),n=k.lineDashType,h=N(n,k.lineThickness);c.setLineDash(h)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:B};r=P(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,g=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var l=!0,u=0,x,s;c.beginPath();if(0<m.length){for(var C=!1,u=0;u<m.length;u++)if(x=m[u].getTime?m[u].x.getTime():m[u].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&
(!k.connectNullData||!C)))if("number"!==typeof m[u].y)0<u&&!(k.connectNullData||C||l)&&(c.stroke(),w&&b.stroke()),C=!0;else{var D=s;x=a.axisX.convertValueToPixel(x);s=a.axisY.convertValueToPixel(m[u].y);var z=k.dataPointIds[u];this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:u,x1:x,y1:s};l||C?(!l&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||n===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(p.x,
...
g,c.setLineDash&&(m[u].lineDashType?(n=m[u].lineDashType,c.setLineDash(N(n,k.lineThickness))):(n=k.lineDashType,c.setLineDash(h))));if(0<m[u].markerSize||0<k.markerSize)D=k.getMarkerProperties(u,x,s,c),f.push(D),z=P(z),w&&f.push({x:x,y:s,ctx:b,type:D.type,size:D.size,color:z,borderColor:z,borderThickness:D.borderThickness});(m[u].indexLabel||k.indexLabel||m[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:m[u],dataSeries:k,point:{x:x,y:s},direction:0>
m[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();w&&b.stroke()}}V.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),b.beginPath());
c.restore();c.beginPath();return{source:d,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};l.prototype.renderSpline=function(a){function d(a){a=v(a,2);if(0<a.length){b.beginPath();w&&e.beginPath();b.moveTo(a[0].x,a[0].y);a[0].newStrokeStyle&&(b.strokeStyle=a[0].newStrokeStyle);a[0].newLineDashArray&&b.setLineDash(a[0].newLineDashArray);w&&e.moveTo(a[0].x,a[0].y);for(var c=0;c<a.length-3;c+=3)if(b.bezierCurveTo(a[c+1].x,a[c+1].y,a[c+2].x,a[c+
...
this._eventManager.ghostCtx;b.save();var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var p=[],t=0;t<a.dataSeriesIndexes.length;t++){var B=a.dataSeriesIndexes[t],k=this.data[B];b.lineWidth=k.lineThickness;var m=k.dataPoints,n="solid";if(b.setLineDash){var q=N(k.nullDataLineDashType,k.lineThickness),n=k.lineDashType,h=N(n,k.lineThickness);b.setLineDash(h)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:B};r=P(r);e.strokeStyle=r;e.lineWidth=
...
0;f<r.length;f++)if(r[f].getTime?B=r[f].x.getTime():B=r[f].x,!(B<a.axisX.dataInfo.viewPortMin||B>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){p=a.axisX.convertValueToPixel(B);t=a.axisY.convertValueToPixel(r[f].y);p=a.axisX.reversed?p+a.plotType.totalDataSeries*n/2-(a.previousDataSeriesCount+m)*n<<0:p-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+m)*n<<0;var l=a.axisX.reversed?p-n<<0:p+n<<0,u;0<=r[f].y?u=k:(u=t,t=k);t>u&&(b=t,t=u,u=b);b=r[f].color?r[f].color:h._colorSet[f%h._colorSet.length];
...
a.axisY.reversed?1:-1,bounds:{x1:p,y1:Math.min(t,u),x2:l,y2:Math.max(t,u)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.yScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:k<a.axisY.bounds.y1?a.axisY.bounds.y1:k>a.axisY.bounds.y2?a.axisY.bounds.y2:k}}};l.prototype.renderStackedColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],p=[],t=[],B=[],k=0,m,n,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=
...
a.dataSeriesIndexes[r],l=this.data[g],u=l.dataPoints;if(0<u.length){var x=5<h&&l.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){m=a.axisX.convertValueToPixel(b);var s=m-a.plotType.plotUnits.length*h/2+a.index*h<<0,C=s+h<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:
...
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.yScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};l.prototype.renderStackedColumn100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],p=[],t=[],B=[],k=0,m,n,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),
k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;m=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.width<<0;var h=a.axisX.dataInfo.minDiff;isFinite(h)||(h=0.3*Math.abs(a.axisX.range));h=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(h)/Math.log(a.axisX.range):Math.abs(h)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&
k>m&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<k)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));h<k&&(h=k);h>m&&(h=m);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var g=
a.dataSeriesIndexes[r],l=this.data[g],u=l.dataPoints;if(0<u.length)for(var x=5<h&&l.bevelEnabled?!0:!1,k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){m=a.axisX.convertValueToPixel(b);n=0!==a.dataPointYSums[b]?100*(u[k].y/a.dataPointYSums[b]):0;var s=m-a.plotType.plotUnits.length*h/2+a.index*h<<0,C=s+h<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&
...
this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.yScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};l.prototype.renderBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
...
k&&(h=k);h>n&&(h=n);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var g=a.dataSeriesIndexes[r],l=this.data[g],u=l.dataPoints;if(0<u.length){var x=5<h&&l.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():
u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){n=a.axisX.convertValueToPixel(b);var s=n-a.plotType.plotUnits.length*h/2+a.index*h<<0,C=s+h<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:0),0<t[b]&&(D=f[b]?f[b]:q,f[b]=m=a.axisY.convertValueToPixel(t[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)B[b]=u[k].y+(B[b]?B[b]:0),m=p[b]?
...
c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.xScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};l.prototype.renderStackedBar100=function(a){var d=
...
c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var g=a.dataSeriesIndexes[r],l=this.data[g],u=l.dataPoints;if(0<u.length){var s=5<h&&l.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&
...
q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};l.prototype.renderArea=function(a){var d,c;function b(){D&&(0<h.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=A:0>a.axisY.viewportMaximum?C=t.y1:0<a.axisY.viewportMinimum&&(C=A),f.lineTo(l,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=h.fillOpacity,f.fill(),f.globalAlpha=1,w&&(p.lineTo(l,C),p.lineTo(D.x,C),p.closePath(),p.fill()),f.beginPath(),f.moveTo(l,u),p.beginPath(),p.moveTo(l,u),D={x:l,y:u})}
...
1].newLineDashArray=N(z,m.lineThickness)):(z=m.lineDashType,s[s.length-1].newLineDashArray=E)));if(0!==n[q].markerSize&&(0<n[q].markerSize||0<m.markerSize)){var aa=m.getMarkerProperties(q,h,r,b);p.push(aa);Q=P(Q);w&&p.push({x:h,y:r,ctx:e,type:aa.type,size:aa.size,color:Q,borderColor:Q,borderThickness:aa.borderThickness})}(n[q].indexLabel||m.indexLabel||n[q].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:n[q],dataSeries:m,point:{x:h,y:r},direction:0>
...
b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};l.prototype.renderStepArea=function(a){var d,c;function b(){D&&(0<h.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=A:0>a.axisY.viewportMaximum?C=t.y1:0<a.axisY.viewportMinimum&&(C=A),f.lineTo(l,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=h.fillOpacity,f.fill(),f.globalAlpha=1,w&&(p.lineTo(l,C),p.lineTo(D.x,
...
k.y1,k.width,k.height),this._eventManager.ghostCtx.restore());f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};l.prototype.renderStackedArea=function(a){function d(){if(!(1>k.length)){for(0<z.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&s.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=z.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(s.closePath(),s.fill(),s.beginPath());k=[]}}var c=
...
z.lineThickness;A="solid";if(b.setLineDash){var aa=N(z.nullDataLineDashType,z.lineThickness);A=z.lineDashType;var E=N(A,z.lineThickness);b.setLineDash(E)}for(var Y=!0,q=0;q<m.length;q++){var f=m[q],fa=null,fa=0<=z.dataPointIndexes[f]?v[z.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!z.connectNullData||!Y)))if("number"!==typeof fa.y)z.connectNullData||(Y||x)||d(),Y=!0;else{h=a.axisX.convertValueToPixel(f);var ma=g[f]?g[f]:0;if(a.axisY.logarithmic||
...
this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),s.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};l.prototype.renderStackedArea100=function(a){function d(){for(0<z.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&A.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=z.fillOpacity;b.fill();
...
"top"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(l);if("left"===this.parent._position||"right"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(w);q.globalAlpha=h};oa(W,U);W.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class","canvasjs-chart-tooltip");this.container.style.position="absolute";this.container.style.height=
    "auto"; this.container.style.boxShadow = "1px 1px 2px 2px rgba(0,0,0,0.1)"; this.container.style.zIndex = "1000"; this.container.style.pointerEvents = "none"; this.container.style.display = "none"; var a; a = '<div style=" width: auto;height: auto;min-width: 50px;'; a += "line-height: auto;"; a += "margin: 0px 0px 0px 0px;"; a += "padding: 5px;"; a +="font-family: Roboto-Regular;";a+="font-weight: normal;";a+="font-style: "+(w?"italic;":"normal;");a+="font-size: 14px;";a+="color: #000000;";a+="text-shadow: 1px 1px 1px rgba(0, 0, 0, 0.1);";
...
this.options.borderColor:f[0].dataPoint.color?f[0].dataPoint.color:f[0].dataSeries.color?f[0].dataSeries.color:f[0].dataSeries._colorSet[f[0].index%f[0].dataSeries._colorSet.length],this.contentDiv.style.borderWidth=this.borderThickness||0===this.borderThickness?this.borderThickness+"px":"2px",this.contentDiv.style.borderRadius=this.cornerRadius||0===this.cornerRadius?this.cornerRadius+"px":"5px",this.container.style.borderRadius=this.contentDiv.style.borderRadius,this.contentDiv.style.fontSize=this.fontSize||
        0 === this.fontSize ? this.fontSize + "px" : "14px", this.contentDiv.style.color = this.fontColor ? this.fontColor : "#000000", this.contentDiv.style.fontFamily = this.fontFamily ? this.fontFamily :"Roboto-Regular;",this.contentDiv.style.fontWeight=this.fontWeight?this.fontWeight:"normal",this.contentDiv.style.fontStyle=this.fontStyle?this.fontStyle:w?"italic":"normal"}catch(m){}"pie"===f[0].dataSeries.type||"doughnut"===f[0].dataSeries.type||"funnel"===f[0].dataSeries.type||"pyramid"===f[0].dataSeries.type||
...
this.options.borderColor:f[0].dataSeries.color?f[0].dataSeries.color:f[0].dataSeries._colorSet[c.index%f[0].dataSeries._colorSet.length]:this.contentDiv.style.borderRightColor=this.contentDiv.style.borderLeftColor=this.contentDiv.style.borderColor=this.options.borderColor?this.options.borderColor:f[0].dataPoint.color?f[0].dataPoint.color:f[0].dataSeries.color?f[0].dataSeries.color:f[0].dataSeries._colorSet[f[0].index%f[0].dataSeries._colorSet.length],this.contentDiv.style.borderWidth=this.borderThickness||
        0 === this.borderThickness ? this.borderThickness + "px" : "2px", this.contentDiv.style.borderRadius = this.cornerRadius || 0 === this.cornerRadius ? this.cornerRadius + "px" : "5px", this.container.style.borderRadius = this.contentDiv.style.borderRadius, this.contentDiv.style.fontSize = this.fontSize || 0 === this.fontSize ? this.fontSize + "px" : "14px", this.contentDiv.style.color = this.fontColor ? this.fontColor : "#000000", this.contentDiv.style.fontFamily = this.fontFamily ? this.fontFamily :"Roboto-Regular;",this.contentDiv.style.fontWeight=
...
c.size,c.color,c.borderColor,c.borderThickness)}}};return l}();y.version="v3.4.9 GA";window.CanvasJS&&(y&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=y)})();
