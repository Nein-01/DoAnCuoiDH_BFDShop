...
<script runat="server">
    ...
    {
        //nếu không phải là quản trị viên hoặc biên tập viên thì không xem được ảnh
        if (!(System.Web.HttpContext.Current.User.IsInRole("Admin")||System.Web.HttpContext.Current.User.IsInRole("Editor")))
        {
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "Nguyễn Xuân Thanh";
        LicenseKey = "F8CR2PU67RWJGX5552VCR8A3QQYJ2Q1W";
        ...
        // feature.
        Images.MaxWidth = 1920;
        Images.MaxHeight = 1080;
        Images.Quality = 100;
        ...
        type = ResourceType.Add( "Ảnh laptop" );
        type.Url = BaseUrl + "ImagesLaptop/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesLaptop/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "Ảnh Mobile/Tablet" );
        type.Url = BaseUrl + "MobileTablet/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "MobileTablet/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "Ảnh bài viết" );
        type.Url = BaseUrl + "NewsImage/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "NewsImage/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "Ảnh phụ kiện" );
        type.Url = BaseUrl + "ImagesAccessory/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesAccessory/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "Ảnh màn hình" );
        type.Url = BaseUrl + "ImagesMonitor/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesMonitor/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "Ảnh linh kiện" );
        type.Url = BaseUrl + "ImagesComponentOfComputer/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesComponentOfComputer/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "Ảnh bàn/ghế" );
        type.Url = BaseUrl + "ImagesDeskChair/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesDeskChair/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "Ảnh thương hiệu" );
        type.Url = BaseUrl + "ImagesBrand/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesBrand/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "Ảnh thể loại" );
        type.Url = BaseUrl + "ImagesGenre/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesGenre/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };
        type = ResourceType.Add( "Ảnh Banner" );
        type.Url = BaseUrl + "ImagesBanner/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesBanner/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "Ảnh liên hệ" );
        type.Url = BaseUrl + "ImagesContact/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesContact/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "Avatar" );
        type.Url = BaseUrl + "ImagesAvatar/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesAvatar/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "Bộ sưu tập" );
        type.Url = BaseUrl + "ImagesCollection/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesCollection/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };
