    ...
    public class ProductsController : Controller
    {
        ...
        public ActionResult RatingProduct(Feedback feedback,Feedback_Image feedback_Image)
        {
            ...
            {                
                ...
                {
                    Notification.set_flash("Lỗi Server AI đánh giá!", "danger");
                    feedback.AI_rated = "Predict error!";
        ...
        //Module call predict AI
        private String sendPOST(String url, String cmt)
        {
            
                var request = (HttpWebRequest)WebRequest.Create(url);
                //request.Timeout = 30000;
                var postData = "data=" + cmt;
